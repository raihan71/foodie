...
const Landing: React.FC = () => {
    useDocumentTitle('Codevcast Network by Raihan Nismara');
                ...
                <main className="mt-10 mx-auto max-w-7xl px-4 sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 lg:px-8 xl:mt-28">
                        <div className="sm:text-center lg:text-left">
                          <h1 className="text-4xl tracking-tight font-extrabold text-gray-900 sm:text-5xl md:text-6xl">
                            ...
                            <span className="block text-gray-600 xl:inline">online business</span>
                          </h1>
                          ...
                          <div className="mt-5 sm:mt-8 sm:flex sm:justify-center lg:justify-start">
                            ...
                            <div className="mt-3 sm:mt-0 sm:ml-3">
                              <a href="#" className="w-full flex items-center justify-center px-8 py-3 border border-transparent text-base font-medium rounded-md text-gray-700 bg-purple-100 hover:bg-gray-200 md:py-4 md:text-lg md:px-10">
                                Live demo
                              </a>
                            </div>
                          </div>
