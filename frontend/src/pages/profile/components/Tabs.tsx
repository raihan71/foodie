...
const linkStyleName = `
    ...
    border-b-4 border-transparent hover:border-gray-800 flex justify-center
...
const Tabs: React.FC<IProps> = ({ username, isOwnProfile, followersCount, followingCount }) => {
    ...
    return (
        <ul className="flex items-center justify-between tablet:justify-evenly flex-wrap laptop:justify-start space-x-1 laptop:space-x-4 px-4 bg-gray-100 laptop:bg-transparent laptop:p-0">
            <li>
                <Link
                    to={`/user/${username}/`}
                    className={`${linkStyleName} ${(activeNav === username || activeNav === '') && 'border-gray-700  border-b-4'}`}
                >
            ...
            <li>
                <Link
                    ...
                    className={`${linkStyleName} ${activeNav === 'info' && 'border-gray-700  border-b-4'}`}
                >
            ...
            <li>
                <Link
                    ...
                    className={`${linkStyleName} ${activeNav === 'followers' && 'border-gray-700 border-b-4'}`}
                >
                    <span className="laptop:text-lg text-gray-700">{followersCount}</span>
            ...
            <li>
                <Link
                    ...
                    className={`${linkStyleName} ${activeNav === 'following' && 'border-gray-700 border-b-4'}`}
                >
                    <span className="laptop:text-lg text-gray-700">{followingCount}</span>
            ...
            {isOwnProfile && (
                <li>
                    <Link
                        ...
                        className={`${linkStyleName} ${activeNav === 'bookmarks' && 'border-gray-700 border-b-4'}`}
                    >
