...
const ThemeToggler = () => {
    ...
    return (
        <div
            className="w-9 h-9 p-2 flex items-center justify-center rounded-full border border-gray-200 hover:bg-gray-100 dark:hover:bg-purple-900 dark:border-gray-800"
        ...
        >
            ...
            C513.669,302.959,510.341,294.34,503.536,289.135z"
                                style={{ fill: `${theme === 'dark' ? 'yellow' : '#cacaca'}` }}
                            />
                        </g>
                    </g>
                </svg>
