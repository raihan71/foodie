...
const Notification: React.FC<IProps> = ({ isAuth }) => {
    ...
    return (
        <div className="relative">
            ...
            {isNotificationOpen && (
                <div className="notification-wrapper border border-transparent dark:border-gray-800 fixed top-14 pb-14 laptop:pb-0 laptop:top-10 right-0 h-screen laptop:h-auto w-full laptop:w-30rem bg-white dark:bg-purple-1000 shadow-lg rounded-md laptop:absolute"
                >
                    {/*  ----- HEADER ----- */}
