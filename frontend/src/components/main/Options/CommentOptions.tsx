...
const CommentOptions: React.FC<IProps> = (props) => {
    ...
    return (
        <div className="comment-option-wrapper relative z-10">
            ...
            {isOpen && (
                <div className=" w-56 flex flex-col bg-white dark:bg-purple-1000 rounded-md shadow-lg overflow-hidden absolute top-8 right-3 border border-gray-200 dark:border-gray-800 divide-y divide-gray-100 dark:divide-gray-800">
                    {props.isOwnComment && (
                        <h4
